...
//Member variables
		...
		*/
		...
		float m_lifeSpan; //time to live
		float m_mass;
		glm::vec3 m_Pos, m_Vel, m_gravity;
		glm::vec3 mColor, mStartColor, mEndColor;
		float mScale, mStartScale, mEndScale;
		float mAlpha, mStartAlpha, mEndAlpha;
};
